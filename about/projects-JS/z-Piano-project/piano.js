/* 1. Create variable with AUDIO context*/
...
/* 
    2. Prevent to continue running the event when key is hold.
    It will happen just once
    It is called GUARD CLAUSE or REPEAT KEYSTROKE
*/
document.addEventListener("keydown", (e) => {
  if (e.repeat) return // prop of the "keydown" event
...
/* 
    3. Create a function which takes a note of NOTE_DETAIL array
*/
function getNoteDetail(keyboardKey) {
  return NOTE_DETAILS.find((n) => `Key${n.key}` === keyboardKey)
}

/* Create a function which play a note */
function playNotes() {
  ...
  /* Create a variable which takes only active notes */
